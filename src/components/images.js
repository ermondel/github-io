...
export default [
  ...
  { path: im5, alt: 'Wooded slope of the Syretsky Gai' },
  { path: im6, alt: 'View of the "Temple of Peace" church from the hill' },
  { path: im7, alt: 'Seafront on the left hand from the Dnieper metro station' },
  { path: im8, alt: 'The Rainbow Park' },
  { path: im9, alt: 'Duck on the Dnieper seafront' },
  { path: im10, alt: 'Turtle in the pond of the Syretsky Gai' },
  { path: im11, alt: 'View of the Dnieper river' },
  { path: im12, alt: 'Trees of the Syretsky Gai' },
  {
    path: im13,
    alt: 'View of Prospect Peremohy near the Zhitomirskaya metro station',
  },
  { path: im14, alt: 'View of the Park Bridge across the Dnieper' },
  { path: im15, alt: 'Pond with ducks in the park' },
  { path: im16, alt: 'Expocenter of Ukraine' },
  { path: im17, alt: 'Sunrise in the park' },
  { path: im18, alt: 'View of the Park Bridge across the Dnieper' },
  { path: im19, alt: 'View of Academician Tupolev Street' },
];
